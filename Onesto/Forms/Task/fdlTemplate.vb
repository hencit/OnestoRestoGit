...
Public Class fdlTemplate
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        Else
            MessageBox.Show("Silahkan pilih template tugas terlebih dahulu!", Me.Text)
        End If
    End Sub
    ...
    Private Sub fdlTemplate_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        With ListView1
            .Clear()
            .View = View.Details
            .Columns.Add("Kode Template Tugas", 150)
            .Columns.Add("Deskripsi", 200)
            .Columns.Add("Kode Dept.", 150)
            .Columns.Add("Dibuat oleh", 150)
        End With

        cmd = New SqlCommand("sp_mt_template_SEL", cn)
        cmd.CommandType = CommandType.StoredProcedure

        Dim prm2 As SqlParameter = cmd.Parameters.Add("@template_deskripsi", SqlDbType.NVarChar, 50)
        ...
        Select Case m_FrmCallerId
            Case "frmTemplateTugas"
                With frmTemplateTugas
                    .TemplateCode = ListView1.SelectedItems.Item(0).SubItems.Item(0).Text
                    .m_Flag = 1
                End With
                autoRefreshMasterTemplate()
        End Select
        Me.Close()
    End Sub
    ...
    Sub autoRefreshMasterTemplate()
        If Application.OpenForms().OfType(Of frmTemplateTugas).Any Then
            Call frmTemplateTugas.frmTemplateRefresh(Nothing, EventArgs.Empty)
        End If
    End Sub
    ...
    Private Sub txtDept_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtDept.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            fdlTemplate_Load(sender, e)
        End If
    End Sub

    Private Sub txtFilter_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtDeskripsi.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            fdlTemplate_Load(sender, e)
        End If
    End Sub
