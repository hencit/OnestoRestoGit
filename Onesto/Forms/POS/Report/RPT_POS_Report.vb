...
Public Class RPT_POS_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Onesto.RPT_POS_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_POS_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_POS_Report = New RPT_POS_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
